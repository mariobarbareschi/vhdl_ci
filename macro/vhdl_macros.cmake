...
macro (add_vhdl_source)
    ...
    foreach (_src_n ${ARGV0})
        ...
        add_custom_target("${ARGV1}" COMMAND ${CMAKE_VHDL_COMPILER} -a "${CMAKE_SOURCE_DIR}/${FILE_SRC}" && ${CMAKE_VHDL_COMPILER} -e "${CMAKE_SOURCE_DIR}/${FILE_SRC}" WORKING_DIRECTORY ${CMAKE_BINARY_DIR})
...
macro (add_testbench_source)
    ...
    foreach (_src ${ARGV0})
        ...
        add_custom_target("${TEST_NAME}" COMMAND ${CMAKE_VHDL_COMPILER} -a "${CMAKE_SOURCE_DIR}/${FILE_SRC}" && ${CMAKE_VHDL_COMPILER} -e "${CMAKE_SOURCE_DIR}/${FILE_SRC}" WORKING_DIRECTORY ${CMAKE_BINARY_DIR})
